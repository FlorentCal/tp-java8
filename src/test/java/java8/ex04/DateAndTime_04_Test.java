...
public class DateAndTime_04_Test {
	...
	public void test_localDateTime_of() {
		...
		LocalDateTime result = LocalDateTime.of(LocalDate.of(2018, 1, 1), LocalTime.of(12, 0));
	...
	public void test_localDateTime_format() {
		...
		LocalDateTime localDateTime = LocalDateTime.of(LocalDate.of(2017, 11, 27), LocalTime.of(12, 0));
